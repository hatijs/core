...
const swisseph = require(join(
  __dirname,
  "..",
  "..",
  "/build/Release/swisseph.node"
));

swisseph.SE_AUNIT_TO_KM = 149597870.7;
...
swisseph.SE_ECL_ALLTYPES_LUNAR =
  swisseph.SE_ECL_TOTAL | swisseph.SE_ECL_PARTIAL | swisseph.SE_ECL_PENUMBRAL;
